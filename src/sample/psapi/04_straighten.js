...
async function main() {
  try {
    ...
    const input = {
      ...
      href: 'https://raw.githubusercontent.com/adobe/adobe-photoshop-api-sdk/testfiles/main/input/input02.jpg',
      storage: sdk.psApiLib.Storage.EXTERNAL,
    }

    const output = {
      href: await awsLib.getSignedUrl('putObject', 'output/test04.png'),
      storage: sdk.psApiLib.Storage.EXTERNAL,
    ...
    console.log(`Output File: ${await awsLib.getSignedUrl('getObject', 'output/test04.png')}\n`)
